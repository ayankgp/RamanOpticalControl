...
if __name__ == '__main__':
    ...
    params = ADict(
        ...
        max_iter=1,
        control_guess=np.asarray([0.000295219, 0.000219229, 0.0140962, 0.0072593, 0.0837432, 600, 7218.48, 64277.3]),  # GECI-ChR2-----14.75
    ...
    params.control_guess = np.asarray(
        [0.000288039, 0.000314177, 0.0171212, 0.00715789, 0.0856234, 600, 6427.23, 67314.3])
    params.control_lower = np.asarray(
        [0.0001, 0.0001, 0.35 * energy_factor, Raman_levels_ChR2[3] * 0.990, 1239.84 * energy_factor / 550.5, 600, 5000,
         50000])
